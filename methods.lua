...
local function sendContact(chat_id, phone, name, disable_web_page_preview)

local url = BASE_URL .. '/sendContact?chat_id=' .. chat_id .. '&phone_number='..phone..'&first_name='..name
